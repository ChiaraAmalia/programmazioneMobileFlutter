...
class RicetteCercaNoLogin extends StatefulWidget {
  RicetteCercaNoLogin({Key? key, required this.title}) : super(key: key);
  ...
  @override
  _RicetteCercaNoLoginState createState() => _RicetteCercaNoLoginState();
}

class _RicetteCercaNoLoginState extends State<RicetteCercaNoLogin> {
